/**
 * One-shot runner for sql-changes/2026-05-19-support-ticket-taxonomy.sql.
 *
 * Usage (from host):
 *   sudo docker exec allaboard365-backend \
 *     node /app/backend/scripts/run-support-ticket-taxonomy-migration.js
 *
...
const sqlFile = path.join(
    ...
    '2026-05-19-support-ticket-taxonomy.sql'
);
