/**
 * CAN-SPAM: marketing email footer + List-Unsubscribe URL for email metadata.
 */
const { signMarketingUnsubscribeToken } = require('./marketingUnsubscribeToken.service');
 ...
 * @param {{ memberId: string, tenantId: string, tenantName?: string, postalLine?: string }} opts
 * @returns {{ htmlWithFooter: string, listUnsubscribeUrl: string|null }}
 */
