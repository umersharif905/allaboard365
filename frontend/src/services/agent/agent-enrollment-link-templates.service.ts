// frontend/src/services/agent/agent-enrollment-link-templates.service.ts
...
export class AgentEnrollmentLinkTemplatesService {
  private static readonly BASE_URL = '/api/me/agent/enrollment-link-templates';

  /**
   * Get enrollment link templates for the authenticated agent
   */
...
export default AgentEnrollmentLinkTemplatesService;