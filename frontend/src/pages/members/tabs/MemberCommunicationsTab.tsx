...
const MemberCommunicationsTab: React.FC<Props> = ({ member }) => {
  ...
  if (!member.UserId) {
    return (
      <div className="p-6">
        ...
        <p className="text-sm text-gray-500">Member has no login account — no communications on record.</p>
      </div>
    );
  }
...
export default MemberCommunicationsTab;
