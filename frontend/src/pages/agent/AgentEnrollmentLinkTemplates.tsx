// frontend/src/pages/agent/AgentEnrollmentLinkTemplates.tsx
import { Edit3, Eye, Link, Plus, RotateCcw, Search, Trash2 } from 'lucide-react';
import React, { useMemo, useState } from 'react';
import AgentEnrollmentLinkTemplateForm from '../../components/forms/AgentEnrollmentLinkTemplateForm';
import {
    useAgentEnrollmentLinkTemplates,
    useCreateAgentEnrollmentLinkTemplate,
    useDeleteAgentEnrollmentLinkTemplate,
    useUpdateAgentEnrollmentLinkTemplate
} from '../../hooks/agent/useAgentEnrollmentLinkTemplates';
import {
...
const AgentEnrollmentLinkTemplates: React.FC = () => {
  ...
  const { data: templatesData, isLoading, error, refetch } = useAgentEnrollmentLinkTemplates(filters);
  const createMutation = useCreateAgentEnrollmentLinkTemplate();
  const updateMutation = useUpdateAgentEnrollmentLinkTemplate();
  const deleteMutation = useDeleteAgentEnrollmentLinkTemplate();
    ...
    <div className="p-6">
      ...
      <div className="mb-6">
        ...
        <p className="text-gray-600">
          Create and manage enrollment link templates for your members
        </p>
      </div>
        ...
        {templates.length === 0 && (
          <div className="text-center py-12">
            ...
            <div className="mt-6">
              <button
                onClick={() => setIsCreateModalOpen(true)}
                className="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-oe-primary hover:bg-oe-primary-dark"
              >
      ...
      {/* Modals */}
      {isCreateModalOpen && (
        <AgentEnrollmentLinkTemplateForm
      ...
      {editingTemplate && (
        <AgentEnrollmentLinkTemplateForm
          ...
          initialData={{
            ...
            linkMetaData: editingTemplate.LinkMetaData,
...
export default AgentEnrollmentLinkTemplates;