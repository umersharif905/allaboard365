...
import VendorImportTenantsPanel from '../../components/vendor/import/VendorImportTenantsPanel';
import { apiService } from '../../services/api.service';

/**
 * Vendor-portal tenants page at /vendor/tenants.
 * VendorAdmin-only — external tenants tied to vendor products for eligibility import.
 */
const VendorImportTenantsPage: React.FC = () => {
  ...
  return (
    <div className="p-6">
      ...
      <VendorImportTenantsPanel vendorId={vendorId} />
    </div>
  );
};

export default VendorImportTenantsPage;
