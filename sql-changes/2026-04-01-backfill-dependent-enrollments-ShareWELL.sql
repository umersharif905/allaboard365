/*
  ...
  TARGET VENDOR: ShareWELL Health/Partners (D2A84803-5A9B-4E97-98A5-BEE1A11BBDA6)

  HOW TO RUN (prod):
  1) Run ai_scripts/audit-ShareWELL-dependent-enrollment-gaps.sql and review rows.
